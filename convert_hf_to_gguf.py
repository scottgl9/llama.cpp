...
class Qwen3_5TextModel(_Qwen35MRopeMixin, _Qwen35MtpMixin, _LinearAttentionVReorderBase):
    model_arch = gguf.MODEL_ARCH.QWEN35


@ModelBase.register("Qwen3_5MoeForConditionalGeneration", "Qwen3_5MoeForCausalLM")
class Qwen3_5MoeTextModel(_Qwen35MRopeMixin, _Qwen35MtpMixin, _LinearAttentionVReorderBase):
